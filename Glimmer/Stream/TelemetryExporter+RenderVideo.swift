...
extension TelemetryRenderer {
    ...
    static func promPacing(
        ...
        // SOURCE CADENCE (host delivery, from source timestamps): the evidence
        // that names the host when a stream judders with transit jitter at ~0.
        ...
        builder.emit("glimmer_source_multi_period_fraction",
                     ...
                     + "trailing ~2s (the host-skipping-frames signal).",
